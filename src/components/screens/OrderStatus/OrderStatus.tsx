...
const OrderStatus: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (paymentData && paymentStatus === 'success' && !isConfirming) {
      ...
      if (orderId && payment_id && (status === 'approved' || collection_status === 'approved')) {
        confirmationAttempted.current = true; // Marcar que ya se intentó la confirmación
        setIsConfirming(true);
        setConfirmationError(null);
        
        console.log('🔄 Iniciando confirmación de pago...', { orderId, payment_id });
      ...
      case 'pending':
        return (
          <div className={styles.iconPending}>
            <svg width="60" height="60" viewBox="0 0 24 24" fill="none">
              <circle cx="12" cy="12" r="10" stroke="#ff9800" strokeWidth="2" fill="#fff8e1"/>
              <path d="M12 6v6l4 2" stroke="#ff9800" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
        );
      case 'failure':
      ...
      default:
        return (
          <div className={styles.iconDefault}>
            <svg width="60" height="60" viewBox="0 0 24 24" fill="none">
              <circle cx="12" cy="12" r="10" stroke="#666" strokeWidth="2" fill="#f5f5f5"/>
              <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M12 17h.01" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
        );
    }
        ...
        <div className={styles.statusCard}>
          ...
          {paymentConfirmed && (
            <div className={styles.successMessage}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" style={{ marginRight: '8px', display: 'inline-block' }}>
          ...
          {confirmationError && (
            <div className={styles.errorMessage}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" style={{ marginRight: '8px', display: 'inline-block' }}>
                ...
                <path d="M12 8v4" stroke="#f44336" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M12 16h.01" stroke="#f44336" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            ...
            <div className={styles.infoGrid}>
              ...
              {paymentData.payment_type && (
                <div className={styles.infoItem}>
                  ...
                  <span className={styles.value}>{paymentData.payment_type}</span>
                </div>
              )}
            </div>
          </div>
